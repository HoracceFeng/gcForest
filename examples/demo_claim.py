...
def claim_data_load():
    training = np.loadtxt(open("/home/jluo80/Desktop/training_1.csv","rb"),delimiter=",",skiprows=1)
    testing = np.loadtxt(open("/home/jluo80/Desktop/testing_1.csv","rb"),delimiter=",",skiprows=1)
    ...
    return (training[:, :-1], training[:, -1]), (testing[:, :-1], testing[:, -1])
...
if __name__ == "__main__":
    ...
    if args.model is None:
        ...
        config = load_json(args.model) # type(config): <class 'dict'>
    ...
    (X_train, y_train), (X_test, y_test) = claim_data_load()
